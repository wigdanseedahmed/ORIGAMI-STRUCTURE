...
class EditTaskScreenWS extends StatefulWidget {
  ...
  @override
  _EditTaskScreenWSState createState() => _EditTaskScreenWSState();
}

class _EditTaskScreenWSState extends State<EditTaskScreenWS> {
  ...
  Future<ProjectModel> readProjectData() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (readProjectContent.milestones != null) {
        for (int i = 0; i < readProjectContent.milestones!.length; i++) {
          _allMilestonesList!
      ...
      if (readProjectContent.skillsRequired != null) {
        for (int k = 0; k < readProjectContent.skillsRequired!.length; k++) {
      ...
      if (readProjectContent.members == null) {
        ...
        for (int i = 0; i < readProjectContent.members!.length; i++) {
          ...
          _allMembersName.add(readProjectContent.members![i].memberUsername!);
        }
      }
  ...
  buildAddComment(Size screenSize) {
    return Container(
      padding: const EdgeInsets.only(
        left: 16,
        right: 20,
