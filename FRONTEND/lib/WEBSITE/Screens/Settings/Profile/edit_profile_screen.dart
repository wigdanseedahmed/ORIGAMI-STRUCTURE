...
class _EditProfileScreenWSState extends State<EditProfileScreenWS> {
  ...
  ///
  List<SoftSkillsDataModel> readSoftSkillsJsonFileContent =
      <SoftSkillsDataModel>[];
  List<SoftSkillsDataModel> filterSoftSkillsJsonFileContent =
      <SoftSkillsDataModel>[];
  ...
  Future<List<SoftSkillsDataModel>> readSoftSkillsInformationJsonData() async {
    ...
    if (response.statusCode == 200) {
      ...
      var adaptabilityList = readSoftSkillsJsonFileContent
          .where((element) => element.softSkillCategory == "Adaptability")
          .toList();
      ...
      var attentionToDetailList = readSoftSkillsJsonFileContent
          .where(
              (element) => element.softSkillCategory == "Attention to Detail")
          .toList();
      if (attentionToDetailList == null) {
        ...
        for (int i = 0; i < attentionToDetailList.length; i++) {
          attentionToDetailSoftSkillsList
              .add(attentionToDetailList[i].softSkill!);
        }
      }

      var communicationList = readSoftSkillsJsonFileContent
          .where(
              (element) => element.softSkillCategory == "Communication Skills")
          .toList();
      ...
      var computerList = readSoftSkillsJsonFileContent
          .where((element) => element.softSkillCategory == "Computer Skills")
          .toList();
      ...
      var creativityList = readSoftSkillsJsonFileContent
          .where((element) => element.softSkillCategory == "Creativity")
          .toList();
      ...
      var leadershipList = readSoftSkillsJsonFileContent
          .where((element) => element.softSkillCategory == "Leadership")
          .toList();
      ...
      var lifeList = readSoftSkillsJsonFileContent
          .where((element) => element.softSkillCategory == "Life Skills")
          .toList();
      if (lifeList == null) {
        lifeSoftSkillsList = [];
      } else {
      ...
      var organizationList = readSoftSkillsJsonFileContent
          .where(
              (element) => element.softSkillCategory == "Organization Skills")
          .toList();
      ...
      var problemSolvingList = readSoftSkillsJsonFileContent
          .where((element) => element.softSkillCategory == "Problem-solving")
          .toList();
      ...
      var socialList = readSoftSkillsJsonFileContent
          .where((element) => element.softSkillCategory == "Social Skills")
          .toList();
      if (socialList == null) {
      ...
      var teamworkList = readSoftSkillsJsonFileContent
          .where((element) => element.softSkillCategory == "Teamwork")
          .toList();
      ...
      var timeManagementList = readSoftSkillsJsonFileContent
          .where((element) => element.softSkillCategory == "Time Management")
          .toList();
      ...
      var workEthicList = readSoftSkillsJsonFileContent
          .where((element) => element.softSkillCategory == "Work Ethic")
          .toList();
                  ...
                  if (snapshot.connectionState == ConnectionState.done) {
                    if (snapshot.hasData) {
                      return FutureBuilder(
                        future: readSoftSkillsInformationJsonData(),
                        builder: (context, snapshot) {
                          if (snapshot.connectionState == ConnectionState.done) {
                            if (snapshot.hasData) {
    ...
    return Column(
      children: [
        ...
        widget.selectedEditProfileSideMenuItemInt == 0
            ...
            : widget.selectedEditProfileSideMenuItemInt == 1
                ? buildGeneral(screenSize)
                : widget.selectedEditProfileSideMenuItemInt == 2
                    ? buildLanguages(screenSize)
                    : widget.selectedEditProfileSideMenuItemInt == 3
                        ? buildEducation(screenSize)
                        : widget.selectedEditProfileSideMenuItemInt == 4
                            ? buildExperience(screenSize)
                            : widget.selectedEditProfileSideMenuItemInt == 5
                                ? buildQualifications(screenSize)
                                : widget.selectedEditProfileSideMenuItemInt == 6
                                    ? buildSoftSkills(screenSize)
                                    : buildHardSkills(screenSize),
      ],
    );
  }
  ...
  buildPersonalInformation(Size screenSize) => Column(
        ...
        children: <Widget>[
          ...
          ProfileCardWS(
            title: "User ID",
            rightWidget: null,
            initialValue: readUserJsonFileContent.userID == null
                ? ''
  ...
  buildGeneral(Size screenSize) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          EditProfileTitleCardWS(
            rightWidget: null,
          ...
          ProfileCardWS(
            ...
            rightWidget: null,
            initialValue: readUserJsonFileContent.countryOfEmployment == null
                ? ''
            ...
            onChanged: (countryOfEmployment) {
              setState(() {
                countryOfEmployment == ""
                    ...
                    : readUserJsonFileContent.countryOfEmployment = countryOfEmployment;
              });
            },
            onFieldSubmitted: (countryOfEmployment) {
              setState(() {
                countryOfEmployment == ""
                    ? readUserJsonFileContent.countryOfEmployment = null
                    : readUserJsonFileContent.countryOfEmployment = countryOfEmployment;
          ...
          ProfileCardWS(
            title: "Work Email",
            rightWidget: null,
            initialValue: readUserJsonFileContent.workEmail == null
                ? ''
          ...
          ProfileCardWS(
            ...
            rightWidget: null,
            initialValue: readUserJsonFileContent.jobDepartment == null
                ? ''
            ...
            onFieldSubmitted: (jobDepartment) {
              setState(() {
                jobDepartment == ""
                    ? readUserJsonFileContent.jobDepartment = null
                    : readUserJsonFileContent.jobDepartment = jobDepartment;
          ...
          ProfileCardWS(
            ...
            rightWidget: null,
            initialValue: readUserJsonFileContent.jobTeam == null
                ? ''
          ...
          ProfileCardWS(
            title: "Job Title",
            rightWidget: null,
            initialValue: readUserJsonFileContent.jobTitle == null
                ? ''
  ...
  buildLanguages(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
          ...
          children: <Widget>[
            EditProfileTitleCardWS(
              rightWidget: IconButton(
                icon: Icon(Icons.add, size: 28, color: primaryColour),
                onPressed: () {
                  setState(() {
            ...
            readUserJsonFileContent.languages == null
                ? Container()
                : SizedBox(
                    height: readUserJsonFileContent.languages!.length * screenSize.height * 0.15,
  ...
  buildEducation(Size screenSize) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          EditProfileTitleCardWS(
            rightWidget: null,
          ...
          buildBachelorsEducation(screenSize),
          buildMastersEducation(screenSize),
          buildPHDEducation(screenSize),
          buildDoctoralEducation(screenSize),
        ],
      );

  ///------------------- BACHELORS -------------------///

  buildBachelorsEducation(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
                            ...
                            children: <Widget>[
                              ...
                              ProfileCardWS(
                                ...
                                onChanged: (institutionName) {
                                  institutionName == ""
                                      ? readUserJsonFileContent
                                      .bachelors![index].institutionName = null
                                      : readUserJsonFileContent
                                      .bachelors![index]
                                      .institutionName = institutionName;
                                },
                                onFieldSubmitted: (institutionName) {
                                  institutionName == ""
                                      ? readUserJsonFileContent
                                      .bachelors![index].institutionName = null
                                      : readUserJsonFileContent
  ...
  buildMastersEducation(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
                            ...
                            children: <Widget>[
                              ...
                              ProfileCardWS(
                                ...
                                onChanged: (institutionName) {
                                  institutionName == ""
                                      ? readUserJsonFileContent
                                      .masters![index].institutionName = null
                                      : readUserJsonFileContent
                                      .masters![index]
                                      .institutionName = institutionName;
                                },
  ...
  selectMastersReferenceFile(
      EducationModel mastersReference, Size screenSize) async {
    /// Upload Reference File
    final file = await FilePicker.platform.pickFiles(
      type: FileType.custom,
      allowedExtensions: ["pdf"],
  ...
  buildPHDEducation(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  selectPHDReferenceFile(EducationModel phdReference, Size screenSize) async {
    /// Upload Reference File
    final file = await FilePicker.platform.pickFiles(
      type: FileType.custom,
      allowedExtensions: ["pdf"],
  ...
  buildDoctoralEducation(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
                            ...
                            children: <Widget>[
                              ...
                              ProfileCardWS(
                                ...
                                onChanged: (institutionName) {
                                  institutionName == ""
                                      ? readUserJsonFileContent
                                      .doctoral![index].institutionName = null
                                      : readUserJsonFileContent
                                      .doctoral![index]
                                      .institutionName = institutionName;
                                },
  ...
  selectDoctoralReferenceFile(
      EducationModel doctoralReference, Size screenSize) async {
    /// Upload Reference File
    final file = await FilePicker.platform.pickFiles(
      type: FileType.custom,
      allowedExtensions: ["pdf"],
  ...
  buildExperience(Size screenSize) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          EditProfileTitleCardWS(
            rightWidget: null,
          ...
          buildWorkExperience(screenSize),
          buildVolunteerExperience(screenSize),
          ProfileItemCardWS(
            title: "C.V.",
            rightWidget: IconButton(
              icon: Icon(
  ...
  buildWorkExperience(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              ProfileCardWS(
                                ...
                                onFieldSubmitted: (jobDescription) {
                                  jobDescription == ""
                                      ? readUserJsonFileContent
                                      .workExperience![index]
                                      .jobDescription = null
                              ...
                              ProfileCardWS(
                                ...
                                onFieldSubmitted: (referencePhoneNumber) {
                                  readUserJsonFileContent.workExperience![index]
                                      .referencePhoneNumber =
                                      referencePhoneNumber;
                                },
                              ...
                              ProfileCardWS(
                                ...
                                onFieldSubmitted: (referenceEmailAddress) {
                                  readUserJsonFileContent.workExperience![index]
                                      .referenceEmailAddress =
                                      referenceEmailAddress;
                                },
  ...
  selectWorkExperienceReferenceFile(
      WorkExperienceModel workReference, Size screenSize) async {
    /// Upload Reference File
    final file = await FilePicker.platform.pickFiles(
      type: FileType.custom,
      allowedExtensions: ["pdf"],
  ...
  buildVolunteerExperience(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
                            ...
                            children: <Widget>[
                              ...
                              ProfileCardWS(
                                ...
                                initialValue: readUserJsonFileContent
                                    ...
                                    .referenceBy!,
                                onChanged: (referenceBy) {
                                  readUserJsonFileContent.volunteerExperience![index]
                                      .referenceBy = referenceBy;
                                },
                                onFieldSubmitted: (referenceBy) {
                                  readUserJsonFileContent.volunteerExperience![index]
  ...
  selectVolunteerExperienceReferenceFile(
      VolunteerExperienceModel volunteerReference, Size screenSize) async {
    /// Upload Reference File
    final file = await FilePicker.platform.pickFiles(
      type: FileType.custom,
      allowedExtensions: ["pdf"],
  ...
  cvBottomSheet(context, Size screenSize) {
    return Container(
      height: 100.0,
  ...
  buildQualifications(Size screenSize) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          EditProfileTitleCardWS(
            rightWidget: null,
          ...
          buildProfessionalQualifications(screenSize),
          buildEducationalQualifications(screenSize),
          buildOtherQualifications(screenSize),
        ],
      );

  ///------------------- PROFESSIONAL QUALIFICATIONS -------------------///
  buildProfessionalQualifications(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  selectProfessionalQualificationsFile(
      QualificationModel certificate, Size screenSize) async {
  ...
  buildEducationalQualifications(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  buildOtherQualifications(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              ProfileCardWS(
                                ...
                                onFieldSubmitted: (qualificationType) {
                                  qualificationType == ""
                                      ? readUserJsonFileContent
                                      .otherQualifications![index]
                                      .qualificationType = null
  ...
  buildHardSkills(Size screenSize) {
      ...
      child: Column(
        ...
        children: <Widget>[
                  ...
                  if (readUserJsonFileContent.jobSpecialization == null) {
                    if (readUserJsonFileContent.jobSubField == null) {
                      if (readUserJsonFileContent.jobField == null) {
                        ...
                        i++) {
                          /// Hard Skill Category
                          if (readHardSkillsJsonFileContent[i]
                              .hardSkillCategory !=
                              null) {
                            if (hardSkillCategoryList.last.contains(
                                readHardSkillsJsonFileContent[i]
                                    .hardSkillCategory!)) {
                              hardSkillCategoryList.last;
                            } else {
                              hardSkillCategoryList.last.add(
                                  readHardSkillsJsonFileContent[i]
                                      .hardSkillCategory!);
                            }
                          } else {
                          ...
                          if (readHardSkillsJsonFileContent[i].hardSkill !=
                              null) {
                            if (hardSkillList.last.contains(
                                readHardSkillsJsonFileContent[i]
                                    .hardSkill!)) {
                              hardSkillList.last;
                            } else {
                              hardSkillList.last.add(
                                  readHardSkillsJsonFileContent[i]
                                      .hardSkill!);
                            }
                          } else {
          ...
          readUserJsonFileContent.hardSkills == null
              ? Container()
              : SizedBox(
            height: readUserJsonFileContent.hardSkills!.length * screenSize.height * 0.35,
            child: ListView.builder(
              physics: const NeverScrollableScrollPhysics(),
              shrinkWrap: true,
                        ...
                        rightWidget: IconButton(
                          onPressed: () {
                            setState(() {
                              ...
                              hardSkillCategoryList
                                  .remove(hardSkillCategoryList[index]);
                              hardSkillList
                                  ...
                                  newHardSkillCategoryValue) {
                                    dropDownState(() {
                                      setState(() {
                                        ...
                                        if (newHardSkillCategoryValue.isEmpty) {
                                          if (readUserJsonFileContent
                                              .hardSkills![
                                          index]
                                              .typeOfSpecialization ==
  ...
  buildSoftSkills(Size screenSize) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          EditProfileTitleCardWS(
            rightWidget: null,
          ...
          buildAdaptabilitySoftSkills(screenSize),
          buildAttentionToDetailSoftSkills(screenSize),
          buildCommunicationSoftSkills(screenSize),
          buildComputerSoftSkills(screenSize),
          buildCreativitySoftSkills(screenSize),
          buildLeadershipSoftSkills(screenSize),
          buildLifeSoftSkills(screenSize),
          buildOrganizationSoftSkills(screenSize),
          buildProblemSolvingSoftSkills(screenSize),
          buildSocialSoftSkills(screenSize),
          buildTeamworkSoftSkills(screenSize),
          buildTimeManagementSoftSkills(screenSize),
          buildWorkEthicSoftSkills(screenSize),
        ],
      );

  ///------------------- ADAPTABILITY -------------------///

  buildAdaptabilitySoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  buildAttentionToDetailSoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  buildCommunicationSoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  buildComputerSoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  buildCreativitySoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  buildLeadershipSoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  buildLifeSoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  buildOrganizationSoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  buildProblemSolvingSoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  buildSocialSoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
                  ...
                  onPressed: () {
                    setState(() {
                      readUserJsonFileContent.socialOrInterpersonalSoftSkills ==
                              null
                          ? readUserJsonFileContent
                              .socialOrInterpersonalSoftSkills = <SkillModel>[]
                          : readUserJsonFileContent
  ...
  buildTeamworkSoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  buildTimeManagementSoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
  ...
  buildWorkEthicSoftSkills(Size screenSize) => Container(
        color: DynamicTheme.of(context)?.brightness == Brightness.light
            ? Colors.white
            : Colors.black12,
        child: Column(
