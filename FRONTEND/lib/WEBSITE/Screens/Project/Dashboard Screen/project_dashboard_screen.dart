...
class ProjectDashboardScreenWS extends StatefulWidget {
  final UserModel? selectedUser;
  final ProjectModel? selectedProject;
  final NavigationMenu navigationMenu;

  const ProjectDashboardScreenWS({
    Key? key,
    this.selectedUser,
  ...
  @override
  State<ProjectDashboardScreenWS> createState() =>
      _ProjectDashboardScreenWSState();
}

class _ProjectDashboardScreenWSState extends State<ProjectDashboardScreenWS> {
  ...
  List<TaskChartDataSelectedProjectWS> taskChartData =
      <TaskChartDataSelectedProjectWS>[];
      ...
      children: [
        ...
        SfCircularChart(
          ...
          series: <CircularSeries>[
            DoughnutSeries<TaskChartDataSelectedProjectWS, String>(
              dataSource: taskChartData,
              pointColorMapper: (TaskChartDataSelectedProjectWS data, _) =>
                  data.color,
              xValueMapper: (TaskChartDataSelectedProjectWS data, _) => data.x,
              yValueMapper: (TaskChartDataSelectedProjectWS data, _) => data.y,
          ...
          child: Center(
            ...
            series: <ChartSeries<PhasesModel, String>>[
              BarSeries<PhasesModel, String>(
                ...
                yValueMapper: (PhasesModel data, _) => data.progressPercentage == null ? 0.0 :
          ...
          series: <ChartSeries<PhasesModel, String>>[
            ...
            BarSeries<PhasesModel, String>(
              ...
              xValueMapper: (PhasesModel data, _) =>
                  data.phase == null ? "Phase" : data.phase!,
              yValueMapper: (PhasesModel data, _) =>
              data.progressPercentage == null ? 0.0 : data.progressPercentage!.toDouble() / 100,
              pointColorMapper: (PhasesModel data, _) =>
                  data.progressPercentage == null ||
                          data.progressPercentage == 0.0
                      ? Colors.grey
          ...
          child: Center(
            ...
            series: <ChartSeries<TaskModel, String>>[
              ...
              BarSeries<TaskModel, String>(
                ...
                data.percentageDone == null ? 0.0 : data.percentageDone!.toDouble() / 100,
...
class TaskChartDataSelectedProjectWS {
  TaskChartDataSelectedProjectWS(this.x, this.y, [this.color]);
