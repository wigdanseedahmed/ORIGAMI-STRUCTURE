...
class AllProjectsDashboardScreenWS extends StatefulWidget {
  const AllProjectsDashboardScreenWS({Key? key}) : super(key: key);

  @override
  State<AllProjectsDashboardScreenWS> createState() =>
      _AllProjectsDashboardScreenWSState();
}

class _AllProjectsDashboardScreenWSState
    extends State<AllProjectsDashboardScreenWS> {
  ...
  late List<TasksChartDataWS> userTaskChartData = <TasksChartDataWS>[];
      ...
      children: [
        ...
        SfCircularChart(
          ...
          series: <CircularSeries>[
            DoughnutSeries<TasksChartDataWS, String>(
              dataSource: userTaskChartData,
              pointColorMapper: (TasksChartDataWS data, _) => data.color,
              xValueMapper: (TasksChartDataWS data, _) => data.x,
              yValueMapper: (TasksChartDataWS data, _) => data.y,
...
class TasksChartDataWS {
  TasksChartDataWS(this.x, this.y, [this.color]);
