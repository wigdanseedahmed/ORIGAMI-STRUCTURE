...
class MenuItemTileWS extends StatefulWidget
{
  final String title;
  final IconData icon;
  ...
  @override
  _MenuItemTileWSState createState() => _MenuItemTileWSState();
}

class _MenuItemTileWSState extends State<MenuItemTileWS>
{
