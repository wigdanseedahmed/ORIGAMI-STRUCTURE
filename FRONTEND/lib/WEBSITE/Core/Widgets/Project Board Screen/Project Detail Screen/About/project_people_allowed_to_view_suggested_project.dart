...
class PeopleWhoAreAllowedToViewProjectWS extends StatefulWidget {
  const PeopleWhoAreAllowedToViewProjectWS({
    Key? key,
  ...
  @override
  State<PeopleWhoAreAllowedToViewProjectWS> createState() =>
      _PeopleWhoAreAllowedToViewProjectWSState();
}

class _PeopleWhoAreAllowedToViewProjectWSState
    extends State<PeopleWhoAreAllowedToViewProjectWS> {
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            if (snapshot.hasData) {
              if (readJsonFileContent.members == null ||
                ...
                for (int i = 0;
                    i < readJsonFileContent.members!.length;
                    i++) {
                  rows.add(
                    PlutoRow(
                      cells: {
    ...
    return Column(
      ...
      children: [
        ...
        Align(
          ...
          child: ProjectDetailHeaderWS(headerTitle: 'PEOPLE WHO ARE\nALLOWED TO VIEW THE\nPROJECT', icon: Icon(
        ...
        bodyViewSelected == "Table"
            ...
            : readJsonFileContent.members!.isEmpty || readJsonFileContent.members == null
            ? Container()
            : buildGridView(
