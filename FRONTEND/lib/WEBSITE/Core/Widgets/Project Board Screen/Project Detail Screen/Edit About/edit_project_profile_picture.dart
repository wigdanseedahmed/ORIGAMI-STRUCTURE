...
class EditProjectProfileAvatarWidgetWS extends StatefulWidget {
  final String? imagePath;
  final String? projectName;
  final VoidCallback onClicked;

  const EditProjectProfileAvatarWidgetWS({
    Key? key,
    this.imagePath,
  ...
  @override
  State<EditProjectProfileAvatarWidgetWS> createState() =>
      _EditProjectProfileAvatarWidgetWSState();
}

class _EditProjectProfileAvatarWidgetWSState
    extends State<EditProjectProfileAvatarWidgetWS> {
      ...
      child: FutureBuilder<ProjectModel>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            if (snapshot.hasData) {
              return buildBody(context, color);
  ...
  buildBody(BuildContext context, Color color) {
    return Center(
              child: Stack(
                children: [
                  buildImage(context),
