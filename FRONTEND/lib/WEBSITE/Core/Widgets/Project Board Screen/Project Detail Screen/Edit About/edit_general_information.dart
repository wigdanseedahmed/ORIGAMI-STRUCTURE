...
class EditProjectGeneralInformationWS extends StatefulWidget {
  const EditProjectGeneralInformationWS({
    Key? key,
  ...
  @override
  State<EditProjectGeneralInformationWS> createState() =>
      _EditProjectGeneralInformationWSState();
}

class _EditProjectGeneralInformationWSState
    extends State<EditProjectGeneralInformationWS>
  ...
  buildBody(BuildContext context, Size screenSize) {
    return Column(
      children: [
              ...
              onPressed: () {
                setState(() {
                  _futureProjectInformation =
                      writeGeneralInformationJsonData(readJsonFileContent);
                });
              },
            )
          ],
        ),
        const ProjectDetailHeaderWS(headerTitle: 'DESCRIPTION'),
        SizedBox(
          ...
          child: TextFormField(
            ...
            maxLines: 250,
            autofocus: false,
            initialValue: readJsonFileContent.projectDescription == null
                ? "Project Description"
            ...
            SizedBox(
              ...
              child: CupertinoDateTextBox(
                initialValue: readJsonFileContent.startDate == null
                    ? DateTime.now()
                    : DateFormat("yyyy-MM-dd").parse(readJsonFileContent.startDate!),
                onDateChange: (DateTime newdate) {
                  //print(newdate);
                  setState(() {
                    readJsonFileContent.startDate = newdate.toIso8601String();
                  });
                },
            ...
            SizedBox(
              ...
              child: CupertinoDateTextBox(
                ...
                onDateChange: (DateTime newdate) {
                  //print(newdate);
                  setState(() {
                    readJsonFileContent.dueDate = newdate.toIso8601String();
                  });
                },
              ...
              child: TextFormField(
                ...
                cursorColor:
                    DynamicTheme.of(context)?.brightness == Brightness.light
                        ...
                        : Colors.grey[600],
                onChanged: (newValue) {
                  readJsonFileContent.duration = double.parse(newValue);
                },
                onFieldSubmitted: (newValue) {
                  readJsonFileContent.duration = double.parse(newValue);
                },
        ...
        SizedBox(height: screenSize.height / 25),
        const ProjectDetailHeaderWS(headerTitle: 'LEADING MEMBERS'),
        Container(
          alignment: Alignment.center,
                            ...
                            child: StatefulBuilder(builder:
                              ...
                              return DropdownSearch<String>(
                                ...
                                onChanged: (String? newValue) {
                                  dropDownState(() {
                                    readJsonFileContent.projectManager =
                                        _allUserNameList![_allUserFullNameList!
                                            .indexWhere((element) =>
                                                element == newValue)];
        ...
        SizedBox(height: screenSize.height / 25),
        const ProjectDetailHeaderWS(headerTitle: 'GENERAL AIMS'),
        SizedBox(
          width: screenSize.width,
          child: TextFormField(
            minLines: 1,
        ...
        SizedBox(height: screenSize.height / 25),
        const ProjectDetailHeaderWS(headerTitle: 'OBJECTIVES'),
        SizedBox(
          width: screenSize.width,
          child: TextFormField(
            minLines: 1,
        ...
        SizedBox(height: screenSize.height / 25),
        const ProjectDetailHeaderWS(headerTitle: 'BENEFITS (KIP)'),
        SizedBox(
          width: screenSize.width,
          child: TextFormField(
            minLines: 1,
        ...
        SizedBox(height: screenSize.height / 25),
        const ProjectDetailHeaderWS(headerTitle: 'DELIVERABLES'),
        SizedBox(
          width: screenSize.width,
          child: TextFormField(
            minLines: 1,
        ...
        SizedBox(height: screenSize.height / 25),
        const ProjectDetailHeaderWS(headerTitle: 'INITIAL RISKS'),
        SizedBox(
          width: screenSize.width,
          child: TextFormField(
            minLines: 1,
        ...
        SizedBox(height: screenSize.height / 25),
        const ProjectDetailHeaderWS(headerTitle: 'EXPECTED OUTCOMES'),
        SizedBox(
          width: screenSize.width,
          child: TextFormField(
            minLines: 1,
        ...
        SizedBox(height: screenSize.height / 25),
        const ProjectDetailHeaderWS(headerTitle: 'Measurable Criteria For Success'),
        SizedBox(
          width: screenSize.width,
          child: TextFormField(
            minLines: 1,
            ...
            cursorColor:
                DynamicTheme.of(context)?.brightness == Brightness.light
                    ...
                    : Colors.grey[600],
            onChanged: (newValue) {
              readJsonFileContent.measurableCriteriaForSuccess = newValue;
            },
            onFieldSubmitted: (newValue) {
              readJsonFileContent.measurableCriteriaForSuccess = newValue;
            },
        ...
        SizedBox(height: screenSize.height / 25),
        const ProjectDetailHeaderWS(headerTitle: 'TYPE OF PROJECT'),
        SizedBox(
          height: typeOfProjectList!.length * screenSize.height * 0.065,
        ...
        SizedBox(height: screenSize.height / 25),
        const ProjectDetailHeaderWS(headerTitle: 'PORTFOLIO AFFILIATION'),
        SizedBox(
        ...
        SizedBox(height: screenSize.height / 25),
        const ProjectDetailHeaderWS(headerTitle: 'SDGs TARGETED'),
        SizedBox(
          height: sdgGoalsList!.length * screenSize.height * 0.068,
          child: ListView.builder(
              physics: const NeverScrollableScrollPhysics(),
                  ...
                  onTap: () {
                    if (readJsonFileContent.sdgs == null) {
                      setState(() {
                        ...
                        readJsonFileContent.sdgs!.add(sdgGoalsList![index]);
                      });
                      //print(readJsonFileContent.theme);
                    } else if (readJsonFileContent.sdgs!
                        .contains(sdgGoalsList![index])) {
                      setState(() {
                        readJsonFileContent.sdgs!.remove(sdgGoalsList![index]);
                      });
