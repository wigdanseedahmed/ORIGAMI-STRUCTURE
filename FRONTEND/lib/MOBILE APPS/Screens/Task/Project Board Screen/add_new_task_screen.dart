...
class AddNewTaskScreenMA extends StatefulWidget {
  ...
  @override
  _AddNewTaskScreenMAState createState() => _AddNewTaskScreenMAState();
}

class _AddNewTaskScreenMAState extends State<AddNewTaskScreenMA> {
  ...
  buildBody(BuildContext context) {
    readTaskContent.criticalityColour = 0;
    readTaskContent.duration = 0.0;
    return Column(
      children: <Widget>[
        Container(
                        ...
                        onDateChange: (DateTime? newDate) {
                          ...
                          setState(() {
                            ...
                            if (readTaskContent.deadlineDate ==
                              ...
                              if (DateTime.parse(readTaskContent.deadlineDate!).isBefore(DateTime.now()) &&
                                  readTaskContent.percentageDone != 100.0) {
                                readTaskContent.progressCategories =  "Behind schedule";
                              } else if (DateTime.parse(readTaskContent.deadlineDate!).isAfter(DateTime.now())){
                                if (readTaskContent.percentageDone == readTaskContent.plannedPercentageDone) {
                                  readTaskContent.progressCategories = "On schedule";
                                } else if (readTaskContent.percentageDone! > readTaskContent.plannedPercentageDone!) {
                                  readTaskContent.progressCategories = "Ahead of schedule";
                                } else {
                                  readTaskContent.progressCategories = "Behind schedule";
                                }
                              }
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (newValue) {
                            setState(() {
                              ...
                              if (readTaskContent.deadlineDate == null || readTaskContent.plannedPercentageDone == null ||  newValue.isEmptyOrNull) {
                                readTaskContent.progressCategories = null;
                              } else {
                                if (DateTime.parse(readTaskContent.deadlineDate!).isBefore(DateTime.now()) == true &&
                                    newValue.toDouble() != 100.0) {
                                  readTaskContent.progressCategories =  "Behind schedule";
                                } else if (DateTime.parse(readTaskContent.deadlineDate!).isAfter(DateTime.now())){
                                  if (newValue.toDouble() == readTaskContent.plannedPercentageDone) {
                                    readTaskContent.progressCategories = "On schedule";
                                  } else if (newValue.toDouble() > readTaskContent.plannedPercentageDone!) {
                                    readTaskContent.progressCategories = "Ahead of schedule";
                                  } else {
                                    readTaskContent.progressCategories = "Behind schedule";
                                  }
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (newValue) {
                            setState(() {
                              ...
                              if (readTaskContent.deadlineDate == null || readTaskContent.percentageDone == null ||  newValue.isEmptyOrNull) {
                                readTaskContent.progressCategories =
                                null;
                              } else {
                                if (DateTime.parse(readTaskContent
                                  ...
                                  if (DateTime.parse(readTaskContent.deadlineDate!).isBefore(DateTime.now()) &&
                                    ...
                                    if (readTaskContent.percentageDone == newValue.toDouble()) {
                                      readTaskContent.progressCategories = "On schedule";
                                    } else if (readTaskContent.percentageDone! > newValue.toDouble()) {
                                      readTaskContent.progressCategories = "Ahead of schedule";
                                    } else {
                                      readTaskContent.progressCategories = "Behind schedule";
                                    }
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.done) {
                      if (snapshot.hasData) {
                        return Column(
                          children: [
                            buildMilestonesTitle(context),
                            const SizedBox(height: 20),
                            buildPhasesTitle(context),
                            const SizedBox(height: 20),
  ...
  buildMilestonesTitle(BuildContext context) {
    return Container(
      alignment: Alignment.center,
  ...
  buildMilestones(BuildContext context) {
    return SizedBox(
  ...
  buildPhasesTitle(BuildContext context) {
    return Container(
      alignment: Alignment.center,
      margin: const EdgeInsets.only(top: 16.0),
      child: Row(
  ...
  buildPhases(BuildContext context) {
    return SizedBox(
      width: MediaQuery.of(context).size.width * 0.75,
      height: 65,
      child: StatefulBuilder(
  ...
  buildChecklists(
    ...
    for (var i = 0; i < fullChecklistList!.length; i++) {
      ...
      for (var j = 0; j < fullChecklistList[i].checklistItems!.length; j++) {
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 1.0),
                    fullChecklistList![index].checklistItems!.isEmpty ||
                            fullChecklistList![index].checklistItems == null
                        ? Container()
                        : SizedBox(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        setState(() {
                          print(fullChecklistItemsList);
                          fullChecklistItemsList!.remove(
                              fullChecklistItemsList![checklistItemIndex]);

                          fullChecklistItemsList!.isEmpty ||
                                  fullChecklistItemsList == []
  ...
  buildAddComment(BuildContext context) {
