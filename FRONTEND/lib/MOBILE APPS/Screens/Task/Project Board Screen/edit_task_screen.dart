...
class EditTaskScreenMA extends StatefulWidget {
  ...
  @override
  _EditTaskScreenMAState createState() => _EditTaskScreenMAState();
}

class _EditTaskScreenMAState extends State<EditTaskScreenMA> {
  ...
  Future<TaskModel>? _futureTaskInformation;

  Future<TaskModel> readingTasksData() async {
    /// String to URI, using the same url used in the nodejs code
    var uri = Uri.parse("${AppUrl.getTaskByTaskName}${widget.taskTitle}");
    ...
    if (response.statusCode == 200) {
      readTaskContent = taskModelFromJson(response.body)[0];
      //print("Project Info : ${readTaskJsonFileContent.taskName}");
  ...
  Future<TaskModel> updateTasksData(TaskModel selectedTaskInformation) async {
    /// String to URI, using the same url used in the nodejs code
    var uri = Uri.parse("${AppUrl.updateTaskByTaskName}${widget.taskTitle}");
  ...
  void initState() {
    ...
    _futureTaskInformation = readingTasksData().then((value) {
      value.taskFiles == null
          ? uploadedFiles = <FileModel>[]
          : uploadedFiles = value.taskFiles!;
  ...
  appBar() {
    return AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            setState(() {
              readTaskContent.dateChanged = DateTime.now();
  ...
  validateInputs() {
    if (readTaskContent.taskName == null) {
      ...
      setState(() {
        // print(readTaskJsonFileContent.projectMilestone);
        readTaskContent.taskFiles = uploadedFiles;

        _futureTaskInformation = updateTasksData(readTaskContent);

        print(readTaskContent.taskFiles);

        widget.navigationMenu == NavigationMenu.projectBoardScreen
            ? Navigator.pushAndRemoveUntil(
                ...
                (route) => false)
            : widget.navigationMenu == NavigationMenu.taskCalendarScreen
                ? Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(
                ...
                : widget.navigationMenu ==
                    ...
                    ? Navigator.pushAndRemoveUntil(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              const WeeklyTaskReportScreenMA(),
                        ),
                        (route) => false)
                    : Navigator.pushAndRemoveUntil(
                        context,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: <Widget>[
                  ...
                  children: [
                    Align(
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          initialValue: readTaskContent.taskName == null
                              ? "Task Name"
                          ...
                          onChanged: (newValue) {
                            setState(() {
                              newValue == "Task Name"
                                  ...
                                  : readTaskContent.taskName = newValue;
                            });
                          },
                    ...
                    SizedBox(
                      ...
                      child: StatefulBuilder(builder:
                        ...
                        return DropdownSearch<String>(
                          ...
                          onChanged: (String? newValue) {
                            dropDownState(() {
                              newValue == null ||  newValue.isEmptyOrNull
                                  ...
                                  : readTaskContent.status = newValue;

                              newValue == "Todo"
                                  ? readTaskContent.percentageDone = 0.0
                          ...
                          //show selected item
                          selectedItem: readTaskContent.status == null
                              ? ""
                    ...
                    SizedBox(
                      ...
                      child: StatefulBuilder(builder:
                        ...
                        return DropdownSearch<String>(
                          ...
                          key: Key(
                            readTaskContent.progressCategories == null
                                ? ""
                                : readTaskContent.progressCategories!,
                          ),
                          //show selected item
                    ...
                    SizedBox(
                      ...
                      child: CupertinoDateTextBox(
                        ...
                        color: DynamicTheme.of(context)?.brightness ==
                            ...
                            ? Colors.grey[700]!
                            : Colors.grey[400]!,
                        initialValue: readTaskContent.startDate == null
                            ? DateTime.now()
                        ...
                        onDateChange: (DateTime? newDate) {
                          //print(newDate);
                          setState(() {
                            newDate == DateTime.now() || newDate == null
                    ...
                    SizedBox(
                      ...
                      child: CupertinoDateTextBox(
                        ...
                        color: DynamicTheme.of(context)?.brightness ==
                            ...
                            ? Colors.grey[700]!
                            : Colors.grey[400]!,
                        initialValue: readTaskContent.deadlineDate ==
                                null
                            ? DateTime.now()
                            : DateFormat('yyyy-MM-dd')
                                .parse(readTaskContent.deadlineDate!),
                        onDateChange: (DateTime? newDate) {
                          // print(newDate);
                          setState(
                            () {
                              ...
                              if (readTaskContent.deadlineDate ==
                                ...
                                if (DateTime.parse(readTaskContent
                                  ...
                                  if (readTaskContent.percentageDone ==
                                      readTaskContent
                        ...
                        hintText: readTaskContent.deadlineDate == null
                            ? DateFormat().format(DateTime.now())
                            : readTaskContent.deadlineDate!,
                      ),
                    ),
                    SizedBox(
                      ...
                      child: CupertinoDateTextBox(
                        ...
                        color: DynamicTheme.of(context)?.brightness ==
                            ...
                            ? Colors.grey[700]!
                            : Colors.grey[400]!,
                        initialValue: readTaskContent.submissionDate ==
                                null
                            ? DateTime.now()
                            : DateFormat("yyyy-MM-dd")
                                .parse(readTaskContent.submissionDate!),
                        onDateChange: (DateTime? newDate) {
                          //print(newDate);
                          setState(() {
                            newDate == DateTime.now() || newDate == null
                                ? readTaskContent.submissionDate = null
                                : readTaskContent.submissionDate =
                                    newDate.toIso8601String();
                          });
                        },
                        hintText: readTaskContent.submissionDate == null
                            ? DateFormat().format(DateTime.now())
                            : readTaskContent.submissionDate!,
                      ),
                    ),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        maxLines: 250,
                        autofocus: false,
                        initialValue: readTaskContent.duration == null
                            ? "0"
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (newValue) {
                            setState(() {
                              ...
                              if (readTaskContent.deadlineDate == null || readTaskContent.plannedPercentageDone == null || newValue == null || newValue.isEmptyOrNull) {
                                readTaskContent.progressCategories =
                                    null;
                              } else {
                                if (DateTime.parse(readTaskContent
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (newValue) {
                            setState(() {
                              ...
                              if (readTaskContent.deadlineDate == null || readTaskContent.percentageDone == null || newValue == null || newValue.isEmptyOrNull) {
                                readTaskContent.progressCategories =
                                    null;
                              } else {
                                if (DateTime.parse(readTaskContent
                    ...
                    Align(
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          textAlign: TextAlign.end,
                          initialValue:
                              readTaskContent.weightGiven == null
                                  ? "0.0\%"
                ...
                const SizedBox(height: 20),
                buildMilestonesTitle(),
                const SizedBox(height: 20),
                buildPhasesTitle(),
                const SizedBox(height: 20),
                buildSkillsRequiredForTaskTitle(),
                const SizedBox(height: 20),
                buildAssignedToTitle(),
                const SizedBox(height: 30),
                buildAssignedByTitle(),
                const SizedBox(height: 20),
                NewTaskInputFieldMA(
                  title: null,
                ...
                NewTaskInputFieldMA(
                  ...
                  onChanged: (newValue) {
                    setState(() {
                      newValue == null || newValue.isEmptyOrNull || newValue == "INITIAL RISKS"
                            ...
                            child: StatefulBuilder(builder:
                              ...
                              return DropdownSearch<String>(
                                ...
                                selectedItem: readTaskContent
                                        ...
                                        null
                                    ? ""
                                    : readTaskContent.issuesCategory!,
                                key: Key(readTaskContent
                                            .issuesCategory ==
                                        null
                                    ? ""
                ...
                widget.navigationMenu ==
                    ...
                    ? NewTaskInputFieldMA(
                        title: null,
                        initialValue:
                            readTaskContent.rootCauseOfIssues == null
                ...
                widget.navigationMenu ==
                    ...
                    ? NewTaskInputFieldMA(
                        title: null,
                        initialValue: readTaskContent.remarks == null
                            ? "REMARKS"
                        ...
                        onChanged: (newValue) {
                          setState(() {
                            newValue == null || newValue.isEmptyOrNull || newValue == "REMARKS"
                                ? readTaskContent.remarks = null
                                : readTaskContent.remarks = newValue;
                          });
                        },
                      )
                    : Container(),
                ...
                widget.navigationMenu ==
                    ...
                    ? NewTaskInputFieldMA(
                        ...
                        onChanged: (newValue) {
                          setState(() {
                            newValue == null ||  newValue.isEmptyOrNull || newValue == "NEXT WEEK OUTLOOK"
                                ? readTaskContent.nextWeekOutlook = null
                                : readTaskContent.nextWeekOutlook =
                                    newValue;
                          });
                ...
                const SizedBox(height: 20),
                readTaskContent.checklist == null || readTaskContent.checklist!.isEmpty
                        ? Container()
                        : buildChecklists(
                            fullChecklistList:
                                readTaskContent.checklist),
                buildCommentOrActivityOrFileTitle(),
                const SizedBox(height: 20),
                showActivities == true
                    ? readTaskContent.activities == null || readTaskContent.activities!.isEmpty
                        ? const SizedBox(height: 240)
                        : buildActivities()
                    : showComments == true
                        ? readTaskContent.comments == null || readTaskContent.comments!.isEmpty
                            ? const SizedBox(height: 240)
                            : buildComments()
                        : showFiles == true
                            ? readTaskContent.taskFiles == null || readTaskContent.taskFiles!.isEmpty
                                ? const SizedBox(height: 240)
                                : buildUploadFiles()
                            : const SizedBox(height: 240),
              ],
        ...
        return DropdownSearch<String>(
          ...
          onChanged: (String? newValue) {
            dropDownState(() {
              ...
              // print(readTaskJsonFileContent.projectPhase );
            });
          },
          onSaved: (String? newValue) {
            dropDownState(() {
      ...
      child: Column(
        children: [
          ...
          readTaskContent.skillsAssigned == null
              ...
              : Align(
                  alignment: Alignment.topRight,
                  child: buildSkillsRequiredForTask(),
                ),
        ],
      ),
    );
                      ...
                      onChanged: (String? newValue) {
                        dropDownState(() {
                          setState(() {
                            ...
                            newValue == null
                                ? readTaskContent
                                    .skillsAssigned![index] = ""
                                : readTaskContent
                                    .skillsAssigned![index] = newValue;
                    ...
                    setState(() {
                      if (readTaskContent.assignedTo != null) {
                        if (readTaskContent.skillsAssigned!.length ==
                          ...
                          readTaskContent.assignedTo!.remove(
                              readTaskContent.assignedTo![index]);
                        }
                      }
                      readTaskContent.skillsAssigned!.remove(
                          readTaskContent.skillsAssigned![index]);

                      readTaskContent.assignedTo == null || readTaskContent.assignedTo!.isEmpty
                          ? readTaskContent.assignedTo = null
                          : readTaskContent.assignedTo;

                      readTaskContent.skillsAssigned == null || readTaskContent.skillsAssigned!.isEmpty
                          ? readTaskContent.skillsAssigned = null
                          : readTaskContent.skillsAssigned;
                    });
                  },
                              ...
                              if (skillName != null) {
                                if (readTaskContent.skillsAssigned ==
                                  ...
                                  if (readTaskContent.skillsAssigned!
                                    ...
                                    readTaskContent
                                        .skillsAssigned![index] = skillName;
                                  }
                                }
                              }
                            }
  ...
  /// CHECKLIST ~ LIST
  buildChecklists({List<ChecklistModel>? fullChecklistList}) {
    int totalItems = 0;
  ...
  /// CHECKLIST ~ ITEMS
  buildChecklistItems({List<ChecklistItemModel>? fullChecklistItemsList}) {
    return ListView.builder(
                      ...
                      child: Row(
                        children: [
                          Container(
                              ...
                              .visible(
                            commentData.selectedEmoji == null || commentData.selectedEmoji!.isEmpty,
  ...
  void fileUpload({PlatformFile? file, TaskModel? selectedTask}) {
    ...
    var uri = Uri.parse("${AppUrl.addAndUpdateTaskFiles}${widget.taskTitle}");
    ...
    // _futureTaskInformation = updateTasksJsonData(readTaskJsonFileContent);
    // print(readTaskJsonFileContent.taskFiles![0].taskBase64File);
  }
