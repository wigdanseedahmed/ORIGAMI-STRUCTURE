...
class ProjectTasksDashboardScreenMA extends StatefulWidget {
  final String projectName;

  const ProjectTasksDashboardScreenMA({Key? key, required this.projectName}) : super(key: key);

  @override
  State<ProjectTasksDashboardScreenMA> createState() =>
      _ProjectTasksDashboardScreenMAState();
}

class _ProjectTasksDashboardScreenMAState
    extends State<ProjectTasksDashboardScreenMA> {
  ...
  Future<UserModel> readingUserJsonData() async {
    ...
    if (response.statusCode == 200) {
      ...
      userTaskChartData = [
        AllUserTaskChartDataTasksDashboardMA(
  ...
  late List<AllUserTaskChartDataTasksDashboardMA> userTaskChartData = <AllUserTaskChartDataTasksDashboardMA>[];
      ...
      children: [
        ...
        SfCircularChart(
          ...
          series: <CircularSeries>[
            DoughnutSeries<AllUserTaskChartDataTasksDashboardMA, String>(
              dataSource: userTaskChartData,
              pointColorMapper: (AllUserTaskChartDataTasksDashboardMA data, _) => data.color,
              xValueMapper: (AllUserTaskChartDataTasksDashboardMA data, _) => data.x,
              yValueMapper: (AllUserTaskChartDataTasksDashboardMA data, _) => data.y,
...
class AllUserTaskChartDataTasksDashboardMA {
  AllUserTaskChartDataTasksDashboardMA(this.x, this.y, [this.color]);
