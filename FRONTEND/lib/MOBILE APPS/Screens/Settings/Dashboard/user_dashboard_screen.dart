...
class UserDashboardScreenMA extends StatefulWidget {
  ...
  @override
  State<UserDashboardScreenMA> createState() =>
      _UserDashboardScreenMAState();
}

class _UserDashboardScreenMAState
    extends State<UserDashboardScreenMA> {
  ...
  late List<UserDashboardChartData> userTaskChartData = <UserDashboardChartData>[];
  ...
  Future<List<TaskModel>> readingTasksJsonData() async {
    ...
    if (response.statusCode == 200) {
      readTaskJsonFileContent = taskModelFromJson(response.body).where((task) => task.assignedTo!.contains(readUserJsonFileContent.username)).toList();
  ...
  late List<UserDashboardChartData> userProjectChartData = <UserDashboardChartData>[];
    ...
    if (response.statusCode == 200) {
      readProjectsJsonFileContent = projectModelFromJson(response.body)
          .where((project) => project.members!
              .where((member) =>
                  member.memberUsername == readUserJsonFileContent.username).isNotEmpty
      ...
      userProjectChartData = [
        UserDashboardChartData(
            ...
            ((readProjectsJsonFileContent.where((element) => element.status == "Expired").length /
        ...
        UserDashboardChartData(
            ...
            ((readProjectsJsonFileContent.where((element) => element.status == "Open").length /
                readProjectsJsonFileContent.length) *
                100)
                .toStringAsFixed(2)
                .toDouble(),
        ...
        UserDashboardChartData(
            ...
            ((readProjectsJsonFileContent.where((element) => element.status == "Future").length /
                readProjectsJsonFileContent.length) *
                100)
                .toStringAsFixed(2)
                .toDouble(),
        ...
        UserDashboardChartData(
            ...
            ((readProjectsJsonFileContent.where((element) => element.status == "Closed").length /
                readProjectsJsonFileContent.length) *
                100)
                .toStringAsFixed(2)
                .toDouble(),
        ...
        UserDashboardChartData(
            ...
            ((readProjectsJsonFileContent.where((element) => element.status == "Suggested").length /
                readProjectsJsonFileContent.length) *
                100)
                .toStringAsFixed(2)
                .toDouble(),
              ...
              SizedBox(
                ...
                child: Text(
                  readUserJsonFileContent.behindScheduleProjectsCount == null
                      ? readUserJsonFileContent.aheadOfScheduleProjectsCount == null
                      ? readUserJsonFileContent.onScheduleProjectsCount == null
            ...
            child: SfCartesianChart(
              ...
              series: <ChartSeries>[
                BarSeries<ProjectModel, String>(
                  ...
                  data.plannedProjectProgressPercentage == null || data.plannedProjectProgressPercentage == 0.0
                      ? null
                ...
                BarSeries<ProjectModel, String>(
                  ...
                  xValueMapper: (ProjectModel data, _) => data.projectName,
                  yValueMapper: (ProjectModel data, _) =>
                  data.progressPercentage == null || data.progressPercentage == 0.0
                      ? null
                ...
                BarSeries<ProjectModel, String>(
                  ...
                  dataSource: readProjectsJsonFileContent,
                  xValueMapper: (ProjectModel data, _) => data.projectName,
                  yValueMapper: (ProjectModel data, _) => data.progressPercentage ==
                      null ||
                      data.plannedProjectProgressPercentage == null
                      ? 0.0
                      : ((data.progressPercentage! - data.plannedProjectProgressPercentage!) /
                      100),
                  pointColorMapper: (ProjectModel data, _) =>
                  data.plannedProjectProgressPercentage == null ||
                      data.progressPercentage == null
                      ? Colors.transparent
                      : data.plannedProjectProgressPercentage! > data.progressPercentage!
                      ? Colors.orangeAccent
                      ...
                      ? Colors.greenAccent
                      : Colors.transparent,
                  dataLabelMapper: (ProjectModel data, _) => data.progressPercentage == null || data.plannedProjectProgressPercentage == null
                    ? ""
                      : data.progressPercentage == 0.0 || data.plannedProjectProgressPercentage == 0.0
                      ? "No Schedule Yet"
                      : data.plannedProjectProgressPercentage! > data.progressPercentage!
