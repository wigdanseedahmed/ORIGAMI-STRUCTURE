...
class AddNewSuggestedProjectDetailScreenMA extends StatefulWidget {
  static const String id = 'project_board_edit_detail_screen';

  final ProjectModel? selectedProject;
  final NavigationMenu navigationMenu;

  const AddNewSuggestedProjectDetailScreenMA({
    Key? key,
    this.selectedProject, required this.navigationMenu,
  }) : super(key: key);

  @override
  _AddNewSuggestedProjectDetailScreenMAState createState() =>
      _AddNewSuggestedProjectDetailScreenMAState();
}

class _AddNewSuggestedProjectDetailScreenMAState
    extends State<AddNewSuggestedProjectDetailScreenMA>
  ...
  Widget build(BuildContext context) {
    ...
    readJsonFileContent.status = "Suggested";
