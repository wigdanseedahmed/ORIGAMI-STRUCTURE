...
class AllProjectsDashboardScreenMA extends StatefulWidget {
  const AllProjectsDashboardScreenMA({Key? key}) : super(key: key);

  @override
  State<AllProjectsDashboardScreenMA> createState() =>
      _AllProjectsDashboardScreenMAState();
}

class _AllProjectsDashboardScreenMAState
    extends State<AllProjectsDashboardScreenMA> {
  ...
  late List<TasksChartData> userTaskChartData = <TasksChartData>[];
      ...
      children: [
        ...
        SfCircularChart(
          ...
          series: <CircularSeries>[
            DoughnutSeries<TasksChartData, String>(
              dataSource: userTaskChartData,
              pointColorMapper: (TasksChartData data, _) => data.color,
              xValueMapper: (TasksChartData data, _) => data.x,
              yValueMapper: (TasksChartData data, _) => data.y,
...
class TasksChartData {
  TasksChartData(this.x, this.y, [this.color]);
